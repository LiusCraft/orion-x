    ...
    "paths": {
        "/api/apikeys": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Name and permission scopes (apikey:scope:*)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/assets/{id}/url": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Set to 1 for a download URL with file name",
                        "name": "download",
                        "in": "query"
                    }
                ],
        ...
        "/api/data/knowledge/bots/{bot_id}/knowledge_bases": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Knowledge base fields",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/data/knowledge/bots/{bot_id}/knowledge_bases/bind": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/data/knowledge/bots/{bot_id}/knowledge_bases/bound": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/data/knowledge/bots/{bot_id}/knowledge_bases/{kb_id}/bind": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/data/knowledge/documents/{doc_id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/data/knowledge/documents/{doc_id}/retry": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/data/knowledge/documents/{doc_id}/status": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/data/knowledge/knowledge_bases": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/data/knowledge/knowledge_bases/{kb_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/data/knowledge/knowledge_bases/{kb_id}/documents": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/data/knowledge/knowledge_bases/{kb_id}/documents/url": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/data/knowledge/knowledge_bases/{kb_id}/search": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/data/memory/agents/{agent_id}/devices": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/data/memory/devices/{device_id}/entries": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/mcp/list-tools": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "MCP connection fields",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/voicebots/{id}/mcps/{serverID}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/voicebots/{id}/mcps/{serverID}/toggle": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
