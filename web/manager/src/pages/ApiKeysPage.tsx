              ...
              <tbody>
                {keys.map((k, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3.5">
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-mono text-zinc-400">
                          {visibleId === k.id
                            ? k.key
                            : k.key.replace(/[^.]/g, "•").slice(0, 20) + "..."}
                        </span>
                        <button
                          onClick={() =>
                            setVisibleId((v) => (v === k.id ? null : k.id))
                          }
                    ...
                    <td className="px-4 py-3.5">
                      <span
                        className={`text-[11px] px-2 py-0.5 rounded border ${SCOPE_BADGE[k.scope] ?? "bg-zinc-800 text-zinc-400 border-zinc-700"}`}
                      >
                        {k.scope}
                      </span>
                    </td>
        ...
        <DialogContent className="bg-zinc-900 border-zinc-800 text-white sm:max-w-md">
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-1.5">
              ...
              <SimpleSelect
                value={form.scope}
                onValueChange={(scope) => setForm((f) => ({ ...f, scope }))}
