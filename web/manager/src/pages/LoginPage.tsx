...
const FEATURES = [
  ...
  { icon: Cpu, title: '灵活 LLM 接入', desc: '支持 OpenAI 兼容接口，自由切换模型' },
  { icon: Zap, title: '实时流式响应', desc: 'VAD 检测 + 流式 ASR/TTS，延迟极低' },
  { icon: Globe, title: 'MCP 工具扩展', desc: '通过 MCP 协议接入外部工具与服务' },
]
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex">
      ...
      />
      <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[480px] h-[480px] bg-violet-600/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="hidden lg:flex w-1/2 items-center justify-center p-16 relative">
        <div className="w-full max-w-sm">
          <div className="flex items-center gap-3 mb-12">
            ...
            <span className="text-xl font-semibold text-white tracking-tight">Orion-X</span>
          </div>

          <p className="text-xs font-semibold text-violet-400 uppercase tracking-widest mb-3">AI Voice Platform</p>
          <h2 className="text-[2.1rem] font-semibold text-white leading-tight mb-4">
            为你的设备注入语音智能
          </h2>
          <p className="text-zinc-400 text-sm leading-relaxed mb-10">
            开源 AI 语音机器人框架，支持多设备管理、可插拔 LLM 和低延迟流式语音对话。
          </p>
          ...
          <p className="text-xs text-zinc-700 mt-14">© 2025 Orion-X · MIT License</p>
        </div>
      </div>
