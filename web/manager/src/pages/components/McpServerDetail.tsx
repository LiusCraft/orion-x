...
export function TagInput({
  ...
  return (
    <div className="flex min-h-9 flex-wrap items-center gap-1.5 rounded-md border border-[hsl(var(--border))] bg-[hsl(var(--card))] px-2.5 py-1.5 transition-[border-color,box-shadow] hover:border-[hsl(var(--muted-foreground)/.55)] focus-within:border-[hsl(var(--primary))] focus-within:ring-2 focus-within:ring-[hsl(var(--primary)/.14)]">
      {tags.map((tag) => (
        <span
          key={tag}
